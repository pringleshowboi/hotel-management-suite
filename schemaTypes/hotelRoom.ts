...
const hotelRoom = {
    ...
    fields: [
        ...
        defineField({
            ...
            type: 'text',
            validation: Rule => Rule.required(),
            initialValue: 'Check-in time is 12PM, checkout time is 11.59AM. If any items are left behind after checking out, please contact the receptionist to be assisted.',
        }),
        defineField({
            name: 'dimension',
            title: 'Dimension',
